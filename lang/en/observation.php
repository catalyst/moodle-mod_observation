...
$string['intlessthanthousand'] = 'Must be an integer that is less than or equal to 1000MB';
...
$string['assignedobservationsession'] = 'You are assigned as an observee for the observation session at this time. Click Go to Activity below to view details.';
...
$string['timeslotdetails'] = 'Timeslot details';
$string['multipletimeslots'] = 'Multiple timelots';
$string['until'] = 'Until (exclusive of)';
$string['repeatevery'] = 'Repeat every';
$string['previewinterval'] = 'Preview interval';
$string['observer_fullname'] = 'Observer name';
$string['observer_email'] = 'Observer email';
$string['timeslots'] = 'Timeslots';
$string['createnew'] = 'Create new';

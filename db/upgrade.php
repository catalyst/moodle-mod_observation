    ...
    if($oldversion < 2021052532) {
        ...
        foreach($filerecords as $file){
            ...
            if($file->filearea != 'response') {
                ...
                $pointresponse = $DB->get_record('observation_point_responses', ['obs_pt_id' => $pointid, 'obs_ses_id' => $sessionid]);
        ...
        // Observation savepoint reached.
        upgrade_mod_savepoint(true, 2021052532, 'observation');
    }
